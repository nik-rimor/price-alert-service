...
class Alert(object):
    ...
    def send(self):
        return requests.post(
            ...
            data={
                ...
                'to': self.user_email,
                'subject': "Price limit reached for {} at {}".format(self.item.name, self.item.price),
    ...
    def find_needing_update(cls, minutes_since_update=AlertConstants.ALERT_TIMEOUT):
        ...
        # return a list of the items the need update based on last time checked and last_update_limit
    ...
    def save_to_mongo(self):
        Database.update(collection=AlertConstants.COLLECTION, query={"_id": self._id}, data=self.json())
    ...
    def find_by_user_email(cls, email):
        return [cls(**elem) for elem in Database.find(collection=AlertConstants.COLLECTION, query={"user_email": email})]
    ...
    def delete(self):
        Database.remove(collection=AlertConstants.COLLECTION, query={"_id": self._id})
